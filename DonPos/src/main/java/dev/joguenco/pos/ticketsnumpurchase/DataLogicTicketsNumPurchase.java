package dev.joguenco.pos.ticketsnumpurchase;

import dev.joguenco.pos.ticketsnum.*;
 ...
 * @author jorgeluis
 */
public class DataLogicTicketsNumPurchase extends BeanFactoryDataSingle {

    private Session s;
    private Row ticketsNumRow;
    private TableDefinition tableDefinitionTicketsNum;

    public DataLogicTicketsNumPurchase() {
    ...
    public PreparedSentence getTicketsNumList() {
        return new PreparedSentence(s,
                ...
                new SerializerWriteBasicExt(new Datas[]{Datas.OBJECT, Datas.STRING},
                        new int[]{1}),
                new DataLogicTicketsNumPurchase.TicketsNumSerializerRead()
        );
    }
