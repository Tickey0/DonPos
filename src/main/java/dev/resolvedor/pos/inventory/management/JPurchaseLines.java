...
public class JPurchaseLines extends javax.swing.JPanel {
    ...
    private PurchaseTableModel m_inventorylines;

    /**
     * Creates new form JInventoryLines
     */
    public JPurchaseLines() {
        ...
        m_inventorylines = new PurchaseTableModel();
    ...
    private static class PurchaseTableModel extends AbstractTableModel {
// JG 16 May 2013 use diamond inference        
        ...
        public Object getValueAt(int row, int column) {
            ...
            switch (column) {
                ...
                case 3:
                    return Formats.CURRENCY.formatValue(i.getTaxPurchase());
                case 4:
